...
define('HEADING_TITLE', 'Logotipo de la Tienda');
...
define('ERROR_IMAGES_DIRECTORY_NOT_WRITEABLE', 'Error: El directorio de las Im&aacute;genes no puede ser subido a. (<a href="%s">click para revisar los permisos del directorio</a>)');
?>