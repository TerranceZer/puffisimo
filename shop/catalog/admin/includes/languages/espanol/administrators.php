...
define('TEXT_INFO_DELETE_INTRO', 'Est&aacute; seguro que desea eliminar este administrador ?');
define('TEXT_INFO_HEADING_NEW_ADMINISTRATOR', 'Nuevo Administrador');
define('TEXT_INFO_USERNAME', 'Nombre Usuario:');
define('TEXT_INFO_NEW_PASSWORD', 'Nueva Contrase&ntilde;a:');
define('TEXT_INFO_PASSWORD', 'Contrase&ntilde;a:');
