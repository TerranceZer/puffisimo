...
define('MODULE_ADMIN_DASHBOARD_LATEST_NEWS_ICON_NEWS', 'Lea las &uacute;ltimas Noticias osCommerce');
define('MODULE_ADMIN_DASHBOARD_LATEST_NEWS_ICON_NEWSLETTER', 'Inscr&iacute;base para recibir el bolet&iacute;n osCommerce');
define('MODULE_ADMIN_DASHBOARD_LATEST_NEWS_ICON_GOOGLE_PLUS', 'C&iacute;rculo de osCommerce en Google+');
