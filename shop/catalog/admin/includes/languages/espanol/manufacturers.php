...
define('TEXT_DELETE_PRODUCTS', 'Quiere borrar tambi&eacute;n todos los productos de este fabricante ? (incluyendo comentarios, ofertas y los productos pr&oacute;ximamente disponibles)');
define('TEXT_DELETE_WARNING_PRODUCTS', '<strong>ADVERTENCIA:</strong> A&uacute;n hay productos que pertenecen a este fabricante!');
