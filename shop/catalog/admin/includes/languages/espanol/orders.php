...
define('ENTRY_CREDIT_CARD_TYPE', 'Tipo Tarjeta Cr&eacute;dito:');
define('ENTRY_CREDIT_CARD_OWNER', 'Titular Tarjeta Cr&eacute;dito:');
define('ENTRY_CREDIT_CARD_NUMBER', 'N&uacute;mero Tarjeta Cr&eacute;dito:');
define('ENTRY_CREDIT_CARD_EXPIRES', 'Caducidad Tarjeta Cr&eacute;dito:');
...
define('TEXT_DATE_ORDER_LAST_MODIFIED', 'Ultima Modificaci&oacute;n:');
define('TEXT_INFO_PAYMENT_METHOD', 'M&eacute;todo de Pago:');

define('TEXT_ALL_ORDERS', 'Todas las Compras');
define('TEXT_NO_ORDER_HISTORY', 'No hay hist&oacute;rico disponible');
...
define('EMAIL_TEXT_STATUS_UPDATE', 'Su pedido ha sido actualizado al siguiente estado.' . "\n\n" . 'Nuevo estado: %s' . "\n\n" . 'Por favor responda a este correo electr&oacute;nico si tiene alguna pregunta que hacer.' . "\n");
