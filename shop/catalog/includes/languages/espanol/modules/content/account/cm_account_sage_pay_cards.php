...
*/
  ...
  define('MODULE_CONTENT_ACCOUNT_SAGE_PAY_CARDS_TITLE', 'P&aacute;gina de Administraci&oacute;n de tarjetas Sage Pay');
  define('MODULE_CONTENT_ACCOUNT_SAGE_PAY_CARDS_DESCRIPTION', 'Agrega una p&aacute;gina de administraci&oacute;n de tarjetas Sage Pay a la zona de Mi Cuenta');

  define('MODULE_CONTENT_ACCOUNT_SAGE_PAY_CARDS_ERROR_MAIN_MODULE', 'Este m&oacute;dulo no se cargar&aacute; hasta que el m&oacute;dulo de pago Sage Pay se haya instalado, configurado y est&eacute; habilitado. Por favor, instale y configure el m&oacute;dulo de pago Sage Pay.');
  ...
  define('MODULE_CONTENT_ACCOUNT_SAGE_PAY_CARDS_TEXT_NO_CARDS', '<p>A&uacute;n no se almacen&oacute; ninguna tarjeta.</p>');
