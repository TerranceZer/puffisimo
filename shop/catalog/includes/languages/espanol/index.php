...
define('TEXT_MAIN', '');
define('TABLE_HEADING_NEW_PRODUCTS', 'Nuevos Productos para el Mes');
...
define('TABLE_HEADING_PRODUCTS', 'Nombre de Producto');
define('TABLE_HEADING_MANUFACTURER', 'Fabricante');
define('TABLE_HEADING_QUANTITY', 'Cantidad');
define('TABLE_HEADING_PRICE', 'precio');
define('TABLE_HEADING_WEIGHT', 'Peso');
define('TABLE_HEADING_BUY_NOW', 'Comprar Ahora');
define('TEXT_NO_PRODUCTS', 'No hay productos disponibles en esta categor&iacute;a.');
