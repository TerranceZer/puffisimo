...
define('HEADER_TITLE_CART_CONTENTS', 'Contenido de la Cesta: ');
...
define('HEADER_TITLE_LOGIN', 'Iniciar Sesi&oacute;n');
...
define('ENTRY_DATE_OF_BIRTH_ERROR', 'Su fecha de nacimiento debe estar en este formato : DD/MM/AAAA (ej 21/05/1970)');
...
define('FOOTER_TEXT_BODY', 'Derechos Reservados &copy; ' . date('Y') . ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a><br />Powered by <a href="http://www.oscommerce.com" target="_blank">osCommerce</a>');
?>